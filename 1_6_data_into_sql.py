...
#連接MySQL
conn = pymysql.connect(host='localhost', port=3306, user='....', passwd='........', db='movie_test', charset='utf8mb4')
print('Successfully connected!')
#建立游標
cursor = conn.cursor()

#將csv寫入SQl
df=pd.read_csv('./Project_movie/1_movie.csv')
# print(df)
counts = 0      #計算筆數
